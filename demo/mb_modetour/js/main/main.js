$(document).ready(function(){
   ...
   var popularcitySwiper = new Swiper('.search-custom .swiper-container', {
	...
	var localSwiper = new Swiper('.mn-bestlocal .ui-tabs-menu.swiper-container, .mn-besttheme .ui-tabs-menu.swiper-container', {
		slidesPerView: 'auto',
		preventClicks: true,
		preventClicksPropagation: false,
		observer: true,
	...
	var $lankTitle = $('.mn-bestlocal .ui-tabs-menu .swiper-slide a, .mn-besttheme .ui-tabs-menu .swiper-slide a');
	...
	var bestItemSwiper = new Swiper('.mn-best .ui-tabs-contents-wrap .swiper-container', {
		slidesPerView: 1.01, 
		spaceBetween: 10,
		observer: true,
		observeParents: true
